...
<li id="six">New Default Investment Fund for Blended Retirement and<br>Beneficiary TSP Participants<a class="back-to-top" href="#top"><div>Back to top</div></a>
<ol class="Alpha">
<!--  A  -->
<li markdown="1">
Effective January 1, 2018, the default investment fund for uniformed services TSP members (and spouse beneficiaries of deceased uniformed services participants) will change from the [Government Securities Investment (G) Fund]({{ site.baseurl }}/funds-individual/g-fund/)to an age-appropriate [Lifecycle (L) Fund]({{ site.baseurl }}/funds-lifecycle/). This change is effective for those service members who joined the uniformed services on or after January 1, 2018, or elected to be covered by BRS. This section discusses how this new plan feature will be implemented and how members, services, and payroll TSP representatives will be affected.
</li>
<!--  B  -->
<li markdown="1">
Detailed information on the L Funds can be found under the [Lifecycle (L) Funds]({{ site.baseurl }}/funds-lifecycle/) section of tsp.gov.
</li>
<!--  C  -->
...
<li id="seven">Processing Service Automatic (1%) Contributions and <br>Matching Contributions<a class="back-to-top" href="#top"><div>Back to top</div></a>
<ol class="Alpha"><!--  VII.A  -->
...
<!--  VIII  -->
<li id="eight">Records, Journal Vouchers and Error Codes List<a class="back-to-top" href="#top"><div>Back to top</div></a>
<ol class="Alpha"><!--  VIII.A  -->
<li>Records.
<ol><!--  VIII.A.1  -->
...
- [Trailer Record (Employee Data, Payment, and Negative Adjustment) (US)]({{ site.baseurl }}/bulletins/Trailer_Record_Employee_Data_Payment_and_Negative_Adjustment_US.pdf)
- [Error Codes and Messages List]({{ site.baseurl }}/bulletins/Error_Codes_and_Messages_List.pdf)
