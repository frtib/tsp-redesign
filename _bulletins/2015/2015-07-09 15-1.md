...
Any non-military service that is creditable under <strong>either</strong> 5 U.S.C. § 8411 (FERS retirement law) <strong>or </strong>5 U.S.C. § 8332 (CSRS retirement law) must be credited when calculating the TSP-SCD. That includes all of the following:
