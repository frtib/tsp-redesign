...
[_Annual Limit on Elective Deferrals_]({{ site.baseurl }}/publications/tspfs07.pdf), and the elective deferral calculator, [How Much Can I Contribute?]({{ site.baseurl }}/calculators/how-much-can-i-contribute/){:target="\_blank"}, for help with their contribution elections. Both are available at tsp.gov.
